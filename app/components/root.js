      ...
      <div>
        ...
        <main>
          ...
          <Switch>
            ...
            <Route exact path={'/campuses/update_campus'} render={(routeProps) => <UpdateCampus {...routeProps}/>} />
            ...
            <Route exact path={'/students/update_student'} render={(routeProps) => <UpdateStudent {...routeProps} />} />
